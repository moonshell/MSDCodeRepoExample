#! /usr/bin/python3
"""InvestigateAnTagDuplicates.py is a script that explores and identifies reversals and duplicate transactions.
...
def readArgs(argv):
    ...
    outputFile = str(inputPath + dsName + '.duplicatesIdentified.txt')
    print("Output file is: " + outputFile)
    outputResults = 'Output/Output.DuplicatesIdentified.' + dsName + '.txt'
...
# Generate Histograms
def investigateAndTagDuplicates(inputFile, outputFile, outputResults):
...
investigateAndTagDuplicates(inputFile, outputFile, outputResults)
